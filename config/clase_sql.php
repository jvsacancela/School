<?php
    class Clase_sql{
        ...
        public function UpdateAlumnos($alum_fech_matric,  $alum_folio,  $alum_tipo, $alum_aaa,  $alum_educacion,  $alum_seccion, $alum_especialidad, $alum_paralelo, $alum_apellido, $alum_nombre, $alum_cedula, $alum_lug_nac,  $alum_fech_nac,  $alum_domicilio,  $alum_telefono,  $alum_civil,  $alum_sex,  $alum_new,  $padre_nombre,  $padre_nacionalidad, $padre_direccion, $padre_profesion, $padre_cedula,  $padre_telefono, $padre_trabajo, $padre_lug_tra, $madre_nombre,  $madre_nacionalidad, $madre_direccion, $madre_profesion, $madre_cedula,  $madre_telefono, $madre_trabajo, $madre_lug_tra, $cliente_nombre, $repre_nombre, $parentesco, $alum_colAnt, $direcc, $i_aaa, $i_tipo, $ii_aa, $repite, $condicionantes, $observacion){
            $resultado = $this->bd->query("UPDATE snp_alumnos SET , alum_fech_matr  = '$alum_fech_matric', alum_folio  = '$alum_folio', alum_tipo_matr  = '$alum_tipo', alum_ao = '$alum_aaa', alum_educacion = '$alum_educacion', alum_seccion = '$alum_seccion', alum_especialidad = '$alum_especialidad', alum_paralelo = '$alum_paralelo', alum_apellido = '$alum_apellido', alum_nombre = '$alum_nombre', alum_cedula = '$alum_cedula', alum_lug_nac = '$alum_lug_nac', alum_fech_nac = '$alum_fech_nac', alum_nacionalidad = '', alum_domicilio = '$alum_domicilio', alum_telefono = '$alum_telefono', alum_civil = '$alum_civil', alum_sexo = '$alum_sex', alum_nuevo = '$alum_new', alum_padre_nombre = '$padre_nombre', alum_padre_nacionalidad = '$padre_nacionalidad', alum_padre_direccion = '$padre_direccion', alum_padre_profesion = '$padre_profesion', alum_padre_cedula = '$padre_cedula', alum_padre_telefono = '$padre_telefono', alum_padre_lug_trab = '$padre_lug_tra', alum_madre_nombre = '$madre_nombre', alum_madre_nacionalidaad = '$madre_nacionalidad', alum_madre_direccion = '$madre_direccion', alum_madre_profesion = '$madre_profesion', alum_madre_cedula = '$madre_cedula', alum_madre_telefono = '$madre_telefono', alum_madre_trabajo = '$madre_trabajo', alum_madre_lug_trab = '$madre_lug_tra', alum_cliente_nombre = '$cliente_nombre', alum_repre_nombre = '$repre_nombre', alum_repre_parentesco = '$parentesco', alum_colant_nombre = '$alum_colAnt', alum_colant_direccion = '$direcc', alum_colant_tipo = '$i_tipo', alum_colant_ao = '$i_aaa', alum_rep_ao = '$repite', alum_condicionantes = '$condicionantes', alum_observacion = '$observacion' WHERE alum_codigo = '' ");
            return $resultado;
        }
